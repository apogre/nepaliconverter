...
import np.org.mpp.conv4.utils.OpenOfficeODFDOMReaderWriter;
...
public class OpenOfficeJacobsOldReaderWriter implements GeneralReaderWriter {
  ...
  public static void main(String[] args) throws Exception {
    OpenOfficeJacobsOldReaderWriter orw = new OpenOfficeJacobsOldReaderWriter();
    //"/home/j/esperanto/nepala vortaro/provo.odt"; "/home/j/Dokumenter/oop/oopj354.odt";

    String fn = "aLotOfStyles";
  ...
  public void convert(String inFile, String outFile, ConversionHandler conversionHandler) throws Exception
  {
    ...
    for (Enumeration zee = zif.entries(); zee.hasMoreElements(); ) {
      ...
      if (content != null && styles != null) {
        {
          convertStylesAndContent(styles, content, conversionHandler);
  ...
  private static Map<String, Node> fontfaceNameToFontFamilyAttrNode(Document styles) throws Exception {
...

    {
      ...
      if (DEBUG > 1)
        System.out.println("fontfaceNameToFontFamilyAttrNode=" + fontfaceNameToFontFamilyAttrNode);
    }
  ...
  public static class Style {
    ...
    public static Map<String, Style> findStyleNodes(Document styles) {
      ...
      if (DEBUG > 1)
        System.out.println("styleNameToNode=" + styleNameToNode.values());

      return styleNameToNode;
    }
  }

  private void convertStylesAndContent(Document styles, Document content, final ConversionHandler conversionHandler) throws Exception {
    ...
    if (DEBUG > 2)
      System.out.println("Samlet styleNameToNode=" + styleNameToNode.values());
    ...
    class X {
        ...
        if (s.stylenodeDecidingFont == null) {
          ...
          for (int i = 0; i < nl.getLength(); i++) {
            ...
            if (na != null && (fontName = na.getNamedItem("style:font-name")) != null) {
              ...
              if (DEBUG > 1)
                System.out.println("Had font name: " + s);
              return;
            }
          }
          ...
          if (parentStyleName != null) {
            ...
            if (s.parentStyle == null)
              throw new IllegalStateException("Unknown parentStyle:" + parentStyleName.getNodeValue());
            ...
            if (DEBUG > 1)
              System.out.println("Had parent: " + s + "    => " + s.parentStyle);
            return;
          }

          // Nothing... hmmm.
          if (DEBUG > 1)
            System.out.println("No font found for style " + s.name);
          s.stylenodeDecidingFont = s;
      ...
      public void convertTextNodeToUnicode(Node textNode) {
        ...
        if (DEBUG > 0)
          System.out.println("-- Konv " + textNode);
        ...
        while (true) {
          ...
          if (DEBUG > 2)
            System.out.println("  konv" + stopcounter + " " + enclosingNode + "   stylen=" + style + "  s=" + s);
        ...
        if (DEBUG > 1)
          System.out.println("   KONV? (" + s.fontBefore + " -> " + font + ")    " + text);
    ...
    for (Style s : styleNameToNode.values())
      x.findNodeDecidingFont(s, styleNameToNode);
