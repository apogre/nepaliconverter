...
public class Kanchan extends NonUnicodeFont
{
...
//*************************************************for Purnabiram and other mark***************************************//
 ...
 //*************************************** for pha,Jha,ka and other**********************************************
			 ...
			 {//for okar and aukar //
				...
				if(ascii_value == 93||ascii_value==125||ascii_value==140)
				{
				    if(ascii_value == 93)
				    {
					output.append("\u094b");
				 ...
				 if(ascii_value==81)
				 {
				   ...
				   if(ascii_value==115)
				   {
					...
					//for the half characters that are present after the rahswa ekar//
				       if(rahswa_fin!="yes")
				       {
							while (ascii_value == 48||ascii_value == 58||ascii_value == 69||ascii_value == 68||ascii_value == 71||ascii_value == 72||ascii_value == 73||ascii_value == 74||ascii_value == 75||ascii_value == 78||ascii_value == 82||ascii_value == 83||ascii_value == 84||ascii_value == 85||ascii_value == 86||ascii_value == 87||ascii_value == 88||ascii_value == 89||ascii_value == 90||ascii_value == 105||ascii_value == 124||ascii_value == 126)
						{
						    i++;
						    array[i]=ascii_value;
						    tmp = input.charAt(p);ascii_value=(int)tmp;p++;
